...
import net.peterkuterna.android.apps.devoxxsched.ui.AboutActivity;
import net.peterkuterna.android.apps.devoxxsched.ui.HomeActivity;
import net.peterkuterna.android.apps.devoxxsched.ui.MyScheduleActivity;
...
public class UIUtils {
    ...
    /**
     * Invoke "MySchedule registration" action, go to {@link MyScheduleActivity}.
     */
    public static void goMyScheduleRegistration(Context context) {
		final Intent intent = new Intent(context, MyScheduleActivity.class);
		context.startActivity(intent);
    }
